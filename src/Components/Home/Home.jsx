...
<div id="home" className={`${styles.home}`}>
          <section className={`d-block ${styles.container}`}>
            <div className="container">
              ...
              <button className={`${styles.button1}`}>
                <a href="/"></a>
                <span className=""></span>Hire Freelancer
                <i className="fa-solid fa-arrow-right ps-3 py-1"></i>
              </button>
              <button className={`${styles.button2}`}>
                <span className=""></span>Start Freelancing
                <i className="fa-solid fa-arrow-right ps-3 py-1"></i>
              </button>
            </div>
          </section>

          <section className={` pt-5 ${styles.container1}`}>
            <div className="row">
              <div className="col-lg-2 col-md-2 col-sm-2"></div>
              <div className="col-lg-2 col-md-2 col-sm-3 d-flex justify-content-start">
                <i className="fa-solid fa-user-tie  text-center mt-4 pe-1 fs-1"></i>
                <div className="mt-3">
                  <h4>800,000</h4>
                  <p>Employers Worldwide</p>
              ...
              <div className="col-lg-7">
                <div className="row">
                  <div className="col-lg-5 pb-4">
                    ...
                    <h1 className="">with Freelancer</h1>
                  </div>
                  <div className="row">
                    <div className="col-lg-6">
                      <h3>The best talent</h3>
          ...
          <div id="beadiv"  className={`container m-5 ${styles.container9}`}>
            <div className={`row m-5 ${styles.row}`}>
              <div
                className={`col-lg-6 col-md-6 col-sm-12 ${styles.muliimage}`}
              >
                <img
            ...
            <div className={`${styles.container8}`}>
              <div className="container">
                <div className="row">
                  <div className="col-lg-4">
                    <h1>
                      Get work done in <span>over 2000 </span>different
                      categories
                    </h1>
                  </div>
